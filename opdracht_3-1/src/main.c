 ...
 *          de eerste letter e in het argument te vinden.
 * @version 1.0
 * @date    18-2-2025
 */
...
int main(int argc, char *argv[]){
  ...
  //Hier wordt het argument doorgelopen totdat er een e is of het argument geëindigd is.
  //Als er een e is dan wordt deze opgeslagen in positie en daarna uitgeprint.
